...
- **Python 3.10+** (Python 3.11 recommended). Used for collection verification (`setup-vstack/scripts/verify.py`), installation tooling, and evaluation test suites.
...
[setup-vstack](./setup-vstack/SKILL.md) (`skills.json` is the
...
python3 setup-vstack/scripts/install.py --dry-run # preview install actions
```
